...
pacman::p_load(magrittr, stringr, dplyr, xml2, lubridate, ggplot2)
```
...
*This readme was adapted from [https://github.com/shannonpileggi/pipinghotdata_distill](https://github.com/shannonpileggi/pipinghotdata_distill).*
